...
4. **After first deploy**, seed the starter data and your admin account by
   ...
   and won't duplicate communities/categories/badges. Promote any other
   user to Editor afterward from `/admin/users`, or pass
   `--editor-email/--editor-password` to the same command.
